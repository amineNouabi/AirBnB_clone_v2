...
class HBNBCommand(cmd.Cmd):
    ...
    types = {
        ...
        'name': str, 'description': str, 'amenity_ids': list,
        'email': str, 'password': str, 'first_name': str,
        'last_name': str, 'city_id': str, 'user_id': str,
    ...
    def do_show(self, args):
        ...
        key = c_name + "." + c_id
        try:
            print(models.storage.all(HBNBCommand.getClass(c_name))[key])
        except KeyError:
    ...
    def do_all(self, args):
        ...
        for v in models.storage.all(HBNBCommand.getClass(args)).values():
